...
export const metadata: Metadata = {
  ...
  description: 'Authentic, verified Google reviews delivered via our engineering infrastructure. Safe, compliant, and permanent. Volume packages from 50 to 1000+ reviews.',
  openGraph: {
    title: 'Buy Verified Google Reviews | RANK PRO',
    description: 'Authentic, verified reviews delivered via our engineering infrastructure. Safe, compliant, and permanent.',
